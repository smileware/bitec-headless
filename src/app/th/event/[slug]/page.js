    ...
    return (
        <div>
            ...
            <article>
                        ...
                        <div className="lg:pr-[60px] order-2 lg:order-1">
                            <div className="h-full flex flex-col lg:justify-between lg:gap-4 text-white text-[20px] pb-5 lg:pb-0">
                                <div className="">
                                    ...
                                    <h1 className="lg:text-[51px] text-[39px] !leading-[1.1] font-[500] text-white mt-[20px]">
                ...
                <div className="relative">
                    ...
                    <div className="max-w-[1380px] mx-auto lg:py-[100px] py-[40px] px-[20px]">
                        <div dangerouslySetInnerHTML={{ __html: event.translations[0].content }} />
                    </div>
                </div>
            ...
            {/* {event.greenshiftScripts?.map((src, index) => (
                <Script key={`th-event-${slug}-${src}-${index}`} src={src} strategy="afterInteractive" />
            ))} */}
        </div>
    );
}
