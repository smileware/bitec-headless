...
export default function ShareButtons({ title, url, color = '#B5B5B8' }) {
    ...
    if (!isClient) {
        return (
            <div className="flex items-center gap-[20px] lg:mt-6">
                <span className="text-[20px] mr-2 font-light" style={{ color }}>SHARE</span>
    ...
    return (
        <div className="flex items-center gap-[20px] lg:mt-6">
            ...
            <a
                ...
                style={{ color }}
            >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-[20px] w-[20px]" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="relative">
                <button
                    ...
                    className="cursor-pointer flex items-center hover:!text-[var(--s-accent)]"
                    title="Copy link"
                    type="button"
                    style={{ color }}
                >
                    <svg width="18" height="10" className="h-[20px] w-[20px]" viewBox="0 0 18 10" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
